...
int main(void)
{
    ...
    problem.phases(1).nodes             = (RowVectorXi(3) << 10,15,30).finished();
    ...
    double x1_lower_ci = -1, x2_lower_ci = -5, x3_lower_ci = -3.1415, x4_lower_ci = - 5;
    double x1_upper_ci = 1 , x2_upper_ci = 5 , x3_upper_ci = 3.1415 , x4_upper_ci = 5;
            ...
            {   
                ...
                {   
                    ...
                    { 
                        ...
                        problem.phases(1).guess.time           = linspace(0.0,5.0,nnodes);
                    }
                    else 
                    {
                    ...
                    // Print in wich problem we are
                    std::cout << std::endl <<"******************************************************************************"<< std::endl <<
                                                "******************************************************************************"<< std::endl <<
                                                "Problema " << count << " resolvido." << std::endl<< 
                                                "******************************************************************************"<< std::endl <<
                                                "******************************************************************************"<<std::endl<<std::endl;
