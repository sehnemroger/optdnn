...
class CustomModel(keras.Model):
    ...
    def train_step(self, data):
        ...
        with tf.GradientTape() as tape: # Allowing automatic differentiation
            ...
            eps = 10# Value for the target V and Vdot
            ## Calculating Vdot
...
mid = keras.layers.Dense(10, activation="sigmoid")(mid)
mid = keras.layers.Dense(10, activation="sigmoid")(mid)
# mid = keras.layers.Dense(90, activation="sigmoid")(mid)
# mid = keras.layers.Dense(80, activation="sigmoid")(mid)
# mid = keras.layers.Dense(70, activation="sigmoid")(mid)
# # mid = keras.layers.Dense(60, activation="sigmoid")(mid)
# # mid = keras.layers.Dense(50, activation="sigmoid")(mid)
# # mid = keras.layers.Dense(40, activation="sigmoid")(mid)
# # mid = keras.layers.Dense(30, activation="sigmoid")(mid)
# mid = keras.layers.Dense(20, activation="sigmoid")(mid)
mid = keras.layers.Dense(10, activation="sigmoid")(mid)
outputs = keras.layers.Dense(4,  activation="linear")(mid)
...
model.compile( metrics=['mse'],optimizer=keras.optimizers.Nadam(learning_rate=0.0001))
model.summary()
...
## Saves the model 
model.save("dnn_trained_small_batch_small.h5")
